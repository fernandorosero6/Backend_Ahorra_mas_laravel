    ...
    <header>
        <div class="container">
           <ul>
            ...
            <li>
                <a href="login/registro" class="nav-link">Registro</a>
            </li>
            <li>
                    ...
                    <div class="form-wrapper">
                        ...
                        <form action="{{ route('register') }}" method="post" class="contact-form">
                            ...
                            <div class="input-wrap w-100">
                                <input class="contact-input" name="identification" type="number" required placeholder="">
                            ...
                            <div class="input-wrap">
                                <input class="contact-input" name="password_confirmation" type="password" required placeholder="">
